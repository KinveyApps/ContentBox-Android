...
import com.kinvey.sample.contentbox.dslv.DragSortController;
import com.kinvey.sample.contentbox.dslv.DragSortListView;
...
public class ReorderFragment extends ContentFragment {
    ...
    private void setAdapter(){
        ...
        adapter = new DraggableTypeAdapter(getActivity(), contents, (LayoutInflater) getActivity().getSystemService(
