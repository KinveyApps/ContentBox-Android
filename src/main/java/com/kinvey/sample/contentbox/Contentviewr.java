...
import com.kinvey.sample.contentbox.model.Target;

import java.io.File;
import java.util.*;

public class Contentviewr extends FragmentActivity{
    ...
    private void preload(){
        ...
        targetAppData.get(new KinveyListCallback<Target>() {
            ...
            public void onSuccess(Target[] result) {
                ...
                getActionBar().setTitle(selectedTarget);
...
//                    drawerLayout.closeDrawer(drawer);
    ...
    public void replaceFragment(Fragment newOne, int id, String descriptor,  boolean backstack){
        if (getBaseContext() == null){
            return;
        }
    ...
    public void addFragment(Fragment newOne, int id, String descriptor,  boolean backstack){
        if (getBaseContext() == null){
            return;
        }
    ...
    public void showList(Fragment newOne){
        if (listbox != null){
            fullContent.setVisibility(View.GONE);
    ...
    public void showWindow(Fragment newOne){
        if (getBaseContext() == null){
            return;
        }
...
//        }
    ...
    public void showFull(Fragment newOne){
